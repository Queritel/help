New currencies can always be added to Queritel Finance if yours is not present by default. Please make sure the currency code is compliant with ISO 4217.
